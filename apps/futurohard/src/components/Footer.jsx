    ...
    <footer className="footer">
      <div className="container footer-grid">
        <div>
          ...
          <div className="pay-chips"><span>MercadoPago</span><span>Transferencia</span></div>
        </div>
        <div><h4>Hardware</h4><ul><li><button onClick={() => onSelectCategory('gpus')}>Placas gráficas</button></li><li><button onClick={() => onSelectCategory('memorias')}>Memorias & Storage</button></li><li><button onClick={() => onSelectCategory('workstations')}>Rigs IA</button></li></ul></div>
